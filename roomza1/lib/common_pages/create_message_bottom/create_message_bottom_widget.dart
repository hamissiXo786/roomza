...
import 'create_message_bottom_model.dart';
export 'create_message_bottom_model.dart';

class CreateMessageBottomWidget extends StatefulWidget {
  const CreateMessageBottomWidget({
    super.key,
  ...
  @override
  State<CreateMessageBottomWidget> createState() =>
      _CreateMessageBottomWidgetState();
}

class _CreateMessageBottomWidgetState extends State<CreateMessageBottomWidget> {
  late CreateMessageBottomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateMessageBottomModel());
