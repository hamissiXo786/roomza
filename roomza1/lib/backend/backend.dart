...
import 'schema/tenant_record.dart';
...
export 'schema/tenant_record.dart';
...
/// Functions to query TenantRecords (as a Stream and as a Future).
Future<int> queryTenantRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TenantRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TenantRecord>> queryTenantRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      TenantRecord.collection(parent),
      TenantRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TenantRecord>> queryTenantRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<int> queryLandlordRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      LandlordRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
