...
import '/common_pages/profile/profile_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<LandlordRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LandlordRecord> messagesLandlordRecordList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final messagesLandlordRecord = messagesLandlordRecordList.isNotEmpty
            ? messagesLandlordRecordList.first
            : null;
              ...
              child: StreamBuilder<List<MessagesRecord>>(
                stream: queryMessagesRecord(
                  queryBuilder: (messagesRecord) => messagesRecord
                      .where(
                        'recieverRef',
                        isEqualTo: messagesLandlordRecord?.reference,
                      )
