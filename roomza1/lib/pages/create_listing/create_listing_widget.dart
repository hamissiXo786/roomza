...
class _CreateListingWidgetState extends State<CreateListingWidget> {
  ...
  void initState() {
    ...
    _model.propTextFieldTextController ??= TextEditingController();
    _model.propTextFieldFocusNode ??= FocusNode();

    _model.floorsizeTextController ??= TextEditingController();
    ...
    _model.noOfBedTextController ??= TextEditingController();
    _model.noOfBedFocusNode ??= FocusNode();

    _model.noOfPepTextController ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<LandlordRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LandlordRecord> createListingLandlordRecordList = snapshot.data!;

        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createListingLandlordRecord =
            createListingLandlordRecordList.isNotEmpty
                ? createListingLandlordRecordList.first
                : null;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .typeOfPropValueController ??=
                                              FormFieldController<String>(null),
                                          options: const ['Single', 'Sharing'],
                                          onChanged: (val) => setState(() =>
                                              _model.typeOfPropValue = val),
                                          width: 347.0,
                                          height: 50.0,
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 0.0, 10.0),
                                        child: Text(
                                          'If apartment has exclusive gender select below',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Roboto',
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          hintText: 'Male only /  Female only ',
                                          icon: Icon(
                                            Icons.keyboard_arrow_down_rounded,
                                            color: FlutterFlowTheme.of(context)
                                                .success,
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          ...
                                          text: 'Upload Property Image/Images',
                                          icon: const Icon(
                                            Icons.cloud_upload,
                                            size: 15.0,
                                          ),
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    if ((_model.uploadedFileUrls.isNotEmpty) ==
                                      ...
                                      await listingRecordReference.set({
                                        ...createListingRecordData(
                                          userRef: currentUserReference,
                                          descOfProp: _model
                                              .propTextFieldTextController.text,
                                          floorSize: _model
                                              .floorsizeTextController.text,
                                          ...
                                          bedrooms: int.tryParse(_model
                                              .noOfBedTextController.text),
                                          noOfPeople: int.tryParse(_model
                                              .noOfPepTextController.text),
                                          whatsAppNum: _model
                                              .contactNumberTextController.text,
                                          landlordRef:
                                              createListingLandlordRecord
                                                  ?.reference,
                                          createdAt: getCurrentTimestamp,
                                          genderExclusive:
                                              _model.maleOrFemaleValue,
                                          addressLatLong:
                                              _model.placePickerValue.latLng,
                                          typeOfProp: _model.typeOfPropValue,
                                          imageHush: _model.uploadedLocalFiles
                                              .first.blurHash,
