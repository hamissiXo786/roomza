...
import '/common_pages/filter/filter_widget.dart';
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemCount: propCards.length,
                                itemBuilder: (context, propCardsIndex) {
                                  final propCardsItem =
                                      propCards[propCardsIndex];
                                  return Visibility(
                                    visible: (propCardsItem.bedrooms >=
                                            FFAppState().bedRooms) &&
                                        ((propCardsItem.cost >=
                                                FFAppState()
                                                    .minPrice
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            builder:
                                                              ...
                                                              child: Icon(
                                                                Icons.favorite,
                                                                color: (currentUserDocument?.favorites.toList() ??
                                                                                [])
                                                                            .contains(propCardsItem
                                                                                .reference) ==
                                                                        true
                                                                    ? FlutterFlowTheme.of(
                                                                            context)
